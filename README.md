...
<p>You can now put the ip-address:8080 into the url bar of your browser and you will be able to see the website. Now you just need to add your roms by making a folder called roms and putting games in their <a href="#List-of-consoles-to-folder-name">respective folder</a>. You should be all set, enjoy playing your roms!</p>
